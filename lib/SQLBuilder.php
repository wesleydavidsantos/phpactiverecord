...
class SQLBuilder
{
     ...
     * @date 09/07/2014
     * Adiciona um ALIAS na consulta Select
    */
    ...
    */
     ...
     * @param $alias - Alias a ser adionado consultas Select (@author Wesley David Santos)
	 * @return SQLBuilder
	...
	{
		$sql = "SELECT $this->select FROM $this->table $this->alias_select";
